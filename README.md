...
The `examples/amazonlinux-internal-nlb-primary` folder contains a deployment setup demonstrating the default options and providing place holders for reuse.
